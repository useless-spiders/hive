...
public class DisplayWin extends JPanel{
    ...
    private JPanel createColumn() {
        ...
        JLabel Wintext = new JLabel("Victoire de " + playerWinner);
    ...
    public void setPlayeurWinner(String playerWinner){ this.playerWinner = playerWinner; }

    public void printWinFrame(){
